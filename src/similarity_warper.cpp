...
SimilarityWarper::SimilarityWarper(const CostFunction& function,
                                   double min_scale)
    : function_(&function), min_scale_(min_scale) {}

SimilarityWarper::SimilarityWarper() : function_(NULL), min_scale_(0.) {}
